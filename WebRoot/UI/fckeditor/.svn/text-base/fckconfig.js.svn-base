...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','-','FontName','FontSize','TextColor','-','FitWindow']
] ;

FCKConfig.ToolbarSets["EmailBody"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About']
] ;

FCKConfig.ToolbarSets["EmailSign"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About']
] ;
