 ...
 * http://www.vinterwebb.se/ SWFUpload is (c) 2006-2007 Lars Huring, Olov Nilz茅n
				...
				switch (g) {
					case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED :
						if (e.queueSizeLimit > f) {
							this.queueData.errorMsg += "队列还可以添加"
									+ f + "张图片.";
						} else {
							this.queueData.errorMsg += "一次最多上传"
									+ e.queueSizeLimit + "张图片,请重新选择.";
						}
						break;
					case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT :
						this.queueData.errorMsg += '文件 "' + d.name
								+ '" 超过大小限制 ('
								+ e.fileSizeLimit + ").";
						break;
