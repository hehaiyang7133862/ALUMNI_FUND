package com.laungee.proj.common.biz;
...
public interface ICommonBiz {
	 ...
	 * 得到对象
	 */
	Object getHQLUnique(String hql) throws Exception;
	 ...
	 * 得到对象
	 */
	Object getSQLUnique(String sql) throws Exception;
	 ...
	 * 得到数字对象
	 */
	int getHQLNum(String hql) throws Exception;

	/**
	 * 得到数字对象
	 */
	int getSQLNum(String hql) throws Exception;
	 ...
	 * 由HQL查询分页
	 */
	List findHQLPage(String hql) throws Exception;
	 ...
	 * 由SQL查询分页
	 */
	List findSQLPage(String hql) throws Exception;

	// ---查询全部
	/**
	 * 由HQL查询全部
	 */
	List findHQL(String hql, List list, int start,int size)
			throws Exception;

	/**
	 * 由HQL查询全部
	 */
	List findHQL(String hql, List list)
			throws Exception;

	/**
	 * 由HQL查询全部
	 */
	List findHQL(String hql) throws Exception;

	/**
	 * 由SQL查询全部
	 */
	List findSQL(String sql, List list, int start,int size)
			throws Exception;

	/**
	 * 由SQL查询全部
	 */
	List findSQL(String sql, List list)
			throws Exception;
	
	/**
	 * 由SQL查询全部
	 */
	List findSQL(String sql) throws Exception;

	// ---查询总数
	/**
	 * 由HQL查询总数
	 */
	int findHQlCount(String hql, List list)
			throws Exception;

	/**
	 * 由HQL查询总数
	 */
	int findHQLCount(String hql) throws Exception;

	/**
	 * 由SQL查询总数
	 */
	int findSQLCount(String hql, List list)
			throws Exception;

	/**
	 * 由SQL查询总数
	 */
	int findSQLCount(String hql) throws Exception;
	
	List findName(String name) throws Exception;
	List findName(String name,List pars) throws Exception;
	
	List fieldList(String code) throws Exception;
