...
public class VwUnalumniRoleOrgan implements java.io.Serializable {
	// Fields
	private Long unAlumniId;
	private String checkup;    //self
	private TbAlumni tbAlumni; //self
	...
	private String konwername;
	private String studyYear;
	private String academyCommNow;
	private String studyAcademy;
	private String  studyMajor;
	private String studyClass;
	private String qqCode;
	private String msnCode;
	private String webopage;
	private Long isNewAdd;	//是否新添加--社区(机构)添加成员时用到
	private Long isJihuo;	//是否激活
	private Long sendmailCount;	//激活邮件发送次数
	private String lastsendDate;	//最后发送日期
	private String jihuoDate;		//激活日期
	private String newestLoginDate;	//最新登录日期
	private String newestip;		//最新登录ip
	...
	/** default constructor */
	public VwUnalumniRoleOrgan() {
	}

	/** minimal constructor */
	public VwUnalumniRoleOrgan(Long unAlumniId) {
	...
	public String getNewestLoginDate() {
		return newestLoginDate;
	}

	public void setNewestLoginDate(String newestLoginDate) {
		this.newestLoginDate = newestLoginDate;
	}
	...
	public String getKonwername() {
		return konwername;
	}

	public void setKonwername(String konwername) {
		this.konwername = konwername;
	}
	...
	public String getAcademyCommNow() {
		return academyCommNow;
	}

	public void setAcademyCommNow(String academyCommNow) {
		this.academyCommNow = academyCommNow;
	}
	...
	public String getWebopage() {
		return webopage;
	}

	public void setWebopage(String webopage) {
		this.webopage = webopage;
	}
}