...
<body>
<div class="float">
<form action="xxgl!doAdd.action" method="post" onSubmit="return checkForm(this)" id="formId">
<table class="lyt_view">
  ...
  <tr>
	...
	<td>
		<select name="foundObject">
			...
			<my:fundField type="OPTION" lead="ACCEPT_OBJECT" ></my:fundField>
		</select>
	</td>  	 	
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
		...
		<iframe class="frm_file" marginheight="0" frameborder="0" src="<%=basePath %>fileList.action?name=TbDonationXxgl&ele=relIds">
		</iframe>
    </td>
  </tr>
</table>
