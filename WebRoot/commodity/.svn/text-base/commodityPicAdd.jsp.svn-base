...
<body>
	<div class="float">
		<form id="formId" enctype="multipart/form-data" action="<%=basePath%>commodity!saveOrUpdatePic.action" method="post" onSubmit="return checkForm(this)">
			<input name="commId" type="hidden" value="${bean.commId}" />
			<input name="picId" type="hidden" value="${bean.picId}" />
			<table class="lyt_view">
				...
				<tr>
					...
					<td width="240">
						<input style="width: 240px" id="pic" name="pic" type="file" />
					</td>
					<td class="lyt_view_note" style="width:54px;">
						图片排序
					</td>
					<td width="80">
						<input style="width:80px" id="numOrder" name="numOrder" type="text" value='<c:out value="${bean.numOrder}" />' maxlength="50" />
					</td>
				</tr>
				<tr>
					<td class="lyt_view_area">
					...
					<td colspan="3">
						<textarea id="picAlt" name="picAlt" style="width:400px;height:80px;" onclick="myArea('picAlt',1000);" onkeyup="myArea('picAlt',1000);" onkeydown="myArea('picAlt',1000);" onchange="myArea('picAlt',1000);"><c:out value='${bean.picAlt}' /></textarea>
					</td>
				</tr>
				<tr>
					<td class="lyt_view_area">
					...
					<td colspan="3">
						<textarea id="memo" name="memo" style="width:400px;height:80px;" onclick="myArea('memo',1000);" onkeyup="myArea('memo',1000);" onkeydown="myArea('memo',1000);" onchange="myArea('memo',1000);"><c:out value='${bean.memo}' /></textarea>
					</td>
				</tr>
			</table>
