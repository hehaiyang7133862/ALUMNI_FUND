...
<%@ include file="commodityHeadReadOnly.jsp"%>
			...
			<tr>
				...
				<td align="right" class="lyt_search_opt">
					<div class="lyt_button">
						<input type="submit" value="查询" style="margin-right:20px"/> </div>
				</td>
		</tr>
		</table>
	</form>
	<table width="100%" border="0" cellspacing="0" class="lyt_result">
		...
		<tr>
			...
			<td>
				<a onclick="MyFormWin.showMyWin('型号详情','<%=basePath%>commodityReadOnly!operationDetail.action?detailId=${temp.detailId}&commId=${bean.commId}',580,310);return false;" href="javascript:;"><c:out value="${temp.detailName }" /></a>
			</td>
			<td>
				<c:choose>
			...
			<td>
				<a onclick="MyFormWin.showMyWin('型号详情','<%=basePath%>commodityReadOnly!operationDetail.action?detailId=${temp.detailId}&commId=${bean.commId}',580,310);return false;" href="javascript:;">详情</a>
			</td>
		</tr>
		</c:forEach>
	</table>
