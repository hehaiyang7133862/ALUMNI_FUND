...
<script type="text/javascript">
	$(document).ready(function(){
		windowResizeFn.add(function(){
				...
				$('#resultDiv').height(document.body.clientHeight-190-$('.lyt_nav').height());
	...
	function goView(id){
		MyFormWin.close();
		MyFormWin.showMyWin('订单详情','<%=basePath%>commodityReadOnly!orderView.action?orderId='+id,580,310);
	}
</script>
</head>
<body>
	...
	<form id="formId" action="<%=basePath%>commodityReadOnly!info.action" method="post" onsubmit="return doSubmit();">
	...
	<table style="width:1510px;" class="lyt_result">
		...
		<tr>
			...
			<td>
				<a href="javascript:;" onclick="goView('${temp.orderId}');">详情</a></td>
			<td>
	...
	<my:page action="commodityReadOnly!info.action"></my:page>
