...
<body>
<div class="float">
<form id="formId" action="<%=basePath%>commodityType!doEdit.action" method="post" onSubmit="return checkForm(this)">
<input name="typeId" type="hidden" value="<c:out value='${bean.typeId}' />" />
<table border="0" cellspacing="0" cellpadding="0" class="lyt_view">
  <tr>
    <td class="lyt_view_note">代码</td>
    <td><input type="text" name="typeCode" id="typeCode" value="${bean.typeCode}" maxlength="50" disabled/><span class="fnt_warn">*</span></td>
  </tr>
  <tr>
    <td class="lyt_view_note">名称</td>
    <td>
    	<input type="text" name="typeName" id="fieldName" value="${bean.typeName}"  maxlength="100" /><span class="fnt_warn">*</span></td>
  </tr>
  <tr>
