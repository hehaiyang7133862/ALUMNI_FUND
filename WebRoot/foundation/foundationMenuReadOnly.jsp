...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div class="nav_GA" style="position: relative;">
	    <ul>
		    <li><a href="<%=basePathMenu%>foundReadOnly!toPage.action?foundId=${foundId }&num=0">基本信息</a></li>
		    <li><a href="<%=basePathMenu%>foundReadOnly!procl.action?foundId=${foundId }&num=1">协议管理</a></li>
	    	<li><a href="<%=basePathMenu%>foundReadOnly!pay.action?foundId=${foundId }&num=2">支出管理</a></li>
	   		<li><a href="<%=basePathMenu%>foundReadOnly!doc.action?foundId=${foundId }&num=3">执行文档</a></li>
	    </ul>
	</div>
    </td>
