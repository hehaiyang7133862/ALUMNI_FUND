...
<head>
	...
	<body>
		<div class="page">
			...
			<form id="formId" action="<%=basePath%>foundReadOnly!payMgt.action" method="get" onsubmit="return doSubmit()">
			...
			<table width="100%" border="0" cellspacing="0" class="lyt_result">
				<tr>
					...
					<th>基金用途</th>
					<th>
						<my:order action="foundReadOnly!payMgt.action" title="支出金额（元）" name="a.payAmount" />
					</th>
					<th>支出账户</th>
					<th>
						<my:order action="foundReadOnly!payMgt.action" title="支出日期" name="a.payDate" />
					</th>
					<th>接受单位</th>
					<th width="60">操作</th>
				</tr>
			...
			<my:page action="foundReadOnly!payMgt.action"></my:page>
		</div>
	</body>
</html>