...
<head>
	...
	<script type="text/javascript">
		...
		function goEdit(id){
			top.uploadTab('协议【'+id+'】详情','协议【'+id+'】详情','<%=basePath%>foundReadOnly!toProPage.action?proId='+id+'&foundId=${foundId}');
		}
	...
	<body>
		<div class="page">
			...
			<form id="formId" action="<%=basePath%>foundReadOnly!procl.action" method="get" onsubmit="return doSubmit()">
			...
			<table style="width: 100%;" border="0" cellspacing="0" class="lyt_result">
				...
				<c:forEach items="${proList}" var="temp" varStatus="status">
					<tr>
						...
						<td>
							<a href="javascript:;" onclick="goEdit('${temp.proId}');">详情</a>
							<a href="javascript:;" onclick="goMingxiMgt('${temp.proId}');">明细</a>
						</td>
					</tr>
				</c:forEach>
			</table>
			<my:page action="foundReadOnly!procl.action"></my:page>
		</div>
	</body>
</html>