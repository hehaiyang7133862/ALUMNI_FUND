...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div class="nav_GA" style="position: relative;">
	    <ul>
		    <li><a href="<%=basePathMenu%>foundReadOnly!toProPage.action?proId=${proId}&foundId=${foundId}&num=0">基本信息</a></li>
		    <li><a href="<%=basePathMenu%>foundReadOnly!proDetailList.action?proId=${proId}&foundId=${foundId}&num=1">捐赠明细</a></li>
	    </ul>
	</div>
    </td>
