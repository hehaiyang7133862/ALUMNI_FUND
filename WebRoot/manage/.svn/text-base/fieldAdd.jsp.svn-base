...
<body>
<div class="float">
<form id="formId" action="<%=basePath%>fieldAdd.action" method="post" onSubmit="return checkForm(this)">
...
<table border="0" cellspacing="0" cellpadding="0" class="lyt_view">
  <tr>
    ...
    <td><input type="text" name="code" value=""  maxlength="50" /><span class="fnt_warn">*</span></td>
  </tr>
  <tr>
    <td class="lyt_view_note">名称</td>
    <td>
    	<input type="text" name="fieldName" value=""  maxlength="100" /><span class="fnt_warn">*</span></td>
  </tr>
  <tr>
