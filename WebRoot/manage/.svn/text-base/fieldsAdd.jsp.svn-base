...
<body>
<div class="float">
<form id="formId" action="<%=basePath%>fieldsAdd.action" method="post" onSubmit="return checkForm(this)">
...
<table border="0" cellspacing="0" cellpadding="0" class="lyt_view">
  <tr>
    ...
    <td><input type="text" name="code" id="code"   maxlength="50" /><span class="fnt_warn">*</span></td>
  </tr>
  <tr>
    <td class="lyt_view_note">名称</td>
    <td>
    	<input type="text" name="fieldName" id="fieldName"   maxlength="100" /><span class="fnt_warn">*</span></td>
  </tr>
  <tr>
    <td class="lyt_view_note">赋值</td>
    <td>
    	<input type="text" name="fieldValue" value=""  maxlength="100" /></td>
  </tr>
  <tr>
    <td class="lyt_view_note">图标</td>
    <td>
    	<input type="text" name="fieldIcon" value=""  maxlength="100" />
        </td>
  </tr>
  <tr>
    <td class="lyt_view_note">叶子</td>
    <td>
    	<select name="isLeaf">
  ...
  <tr>
    ...
    <td>
      <textarea name="memo" id="memoId" ></textarea></td>
  </tr>
</table>
