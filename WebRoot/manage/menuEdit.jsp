...
<table border="0" cellspacing="0" cellpadding="0" class="lyt_view">
  ...
  <tr>
    ...
    <td>
      <input type="text" name="code" value="<c:out value='${bean_menu.code}' />"  maxlength="50" disabled/><span class="ico_warn">*</span></td>
  </tr>
  ...
  <tr>
    ...
    <td>
    	<input type="text" name="urlIcon" value="<c:out value='${bean_menu.urlIcon}' />"  maxlength="100" />
    </td>
  </tr>
    <tr>
    <td>&nbsp;</td>
    <td>
    	<c:if test="${not empty bean_menu.urlIcon}">
    	<img src="<%=basePath%><c:out value='${bean_menu.urlIcon}' />" />
    	</c:if>
    </td>
  </tr>
  </c:if>
