...
<html>
	...
	<body>
		<div class="float">
		<form id="formId" name="formId" action="<%=basePath%>zcOtherOrder!markUpdate.action" method="post" onsubmit="return checkForm(this);">
			...
			<my:timeView idField="orderId" table="TbZcotherOrder" value="${bean.orderId}"></my:timeView>
