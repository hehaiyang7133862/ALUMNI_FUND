...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div id="topMenu_nav_GA" class="nav_GA" style="position: relative;">
	    <ul>
		    <li><a href="<%=basePathMenu%>zcProjEdit.action?projId=${bean.projId}&num=0">基本信息</a></li>
		    <li><a href="<%=basePathMenu%>zcProjEdit!picList.action?projId=${bean.projId}&num=1">项目图片</a></li>
		    <li><a href="<%=basePathMenu%>zcProjEdit!optionList.action?projId=${bean.projId}&num=2">项目选项</a></li>
		    <li><a href="<%=basePathMenu%>zcProjEdit!gressList.action?projId=${bean.projId}&num=3">项目进展</a></li>
		    <li><a href="<%=basePathMenu%>zcProjEdit!orderList.action?projId=${bean.projId}&num=4">捐赠列表</a></li>
	    </ul>
	</div>
    </td>
