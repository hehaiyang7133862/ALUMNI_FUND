...
<html>
	...
	<body>
		<div class="page">
			...
			<form id="formId" action="<%=basePath%>zcProjEditReadOnly!optionList.action" method="get" onsubmit="return doSubmit()">
			...
			<table border="1" cellspacing="0" cellpadding="0" class="lyt_result">
				...
				<tr>
					...
					<td>
						<a href="javascript:;" onclick="MyFormWin.showMyWin('选项详情','<%=basePath%>zcProjEditReadOnly!optionEdit.action?projId=${bean.projId}&optionId=${temp.optionId}',580,260);return false;">详情</a>
					</td>
				</tr>
				</c:forEach>
			</table>
