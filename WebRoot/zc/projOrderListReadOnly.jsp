...
<html>
	<head>
		...
		function goView(id){
			MyFormWin.close();
			MyFormWin.showMyWin('捐赠详情','<%=basePath%>zcProjEditReadOnly!orderView.action?orderId='+id,580,310);
		}
	...
	<body>
		<div class="page">
			...
			<form id="formId" action="<%=basePath%>zcProjEditReadOnly!orderList.action" method="get" onsubmit="return doSubmit()">
			...
			<table border="1" cellspacing="0" cellpadding="0" class="lyt_result" style="width:2140px;">
				<tr>
					<th width="40">序号</th>
					<th width="80">
						<my:order action="zcProjEditReadOnly!orderList.action" title="捐赠单号" name="a.orderNum" />
					</th>
					<th width="80">
						<my:order action="zcProjEditReadOnly!orderList.action" title="项目选项" name="a.optionName" />
					</th>
					<th width="40">
						<my:order action="zcProjEditReadOnly!orderList.action" title="份数" name="a.optionCount" />
					</th>
					<th width="60">
						<my:order action="zcProjEditReadOnly!orderList.action" title="捐赠币种" name="a.orderAmountType" />
					</th>
					<th width="60">
						<my:order action="zcProjEditReadOnly!orderList.action" title="捐赠币种总金额" name="a.orderAmountView" />
					</th>
					<th width="60">
						<my:order action="zcProjEditReadOnly!orderList.action" title="实算总金额（元）" name="a.orderAmount" />
					</th>
					<th width="100">
						<my:order action="zcProjEditReadOnly!orderList.action" title="捐赠方式" name="a.orderType" />
					</th>
					<th width="45">捐赠状态</th>
					<th width="85">
						<my:order action="zcProjEditReadOnly!orderList.action" title="提交时间" name="a.orderTime" />
					</th>
					<th width="85">
						<my:order action="zcProjEditReadOnly!orderList.action" title="付款时间" name="a.orderOkTime" />
					</th>
					<th width="30">
						<my:order action="zcProjEditReadOnly!orderList.action" title="捐赠人类型" name="a.personType" />
					</th>
					<th width="30">
						<my:order action="zcProjEditReadOnly!orderList.action" title="捐赠人数" name="a.personCount" />
					</th>
					<th width="60">操作</th>
					<th width="30">需要证书</th>
					<th width="30">需要发票</th>
			...
			<my:page action="zcProjEditReadOnly!orderList.action"></my:page>
