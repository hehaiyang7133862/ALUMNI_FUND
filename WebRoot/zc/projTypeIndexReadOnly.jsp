				...
				html:'<div id="tree-panel" style="overflow:hidden;"></div>'
             	...
             	items: [{
					...
					html: '<div id="myMap" class="lyt_nav"><c:out value="${bean.typeName}"/></div>'
             		...
             		border: false,
              		padding: '0 5 5 5',
	             	html: '<iframe id="myFrame" name="myFrame" width="100%" height="100%" scrolling="auto" frameborder="0" src="<%=basePath%>zcProjReadOnly!list.action?typeId=${bean.typeId}"></iframe>'
	         	}]
            }]
		});
	});
