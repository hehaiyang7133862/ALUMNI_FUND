...
public class VwRepeatAlumniCardNum implements java.io.Serializable  {
	...
	/** default constructor */
	public VwRepeatAlumniCardNum() {
	}

	/** full constructor */
	public VwRepeatAlumniCardNum(Long sid, Long rid, Long alumniId,
