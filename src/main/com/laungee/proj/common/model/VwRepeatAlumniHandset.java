...
/**
 * VwRepeatAlumniNameId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class VwRepeatAlumniHandset implements java.io.Serializable {
	...
	/** default constructor */
	public VwRepeatAlumniHandset() {
	}

	/** full constructor */
	public VwRepeatAlumniHandset(Long sid, Long rid, Long alumniId,
			String nameCn, String nameEn, String isLive, String cardNum,
			String sexCid, Long nationFid, Long countryFid, String birthDay,
			Long birthCountryFid, Long birthProvinceFid, Long birthCityFid,
			String birthDetail, Long liveCountry1Fid, Long liveProvince1Fid,
			Long liveCity1Fid, String liveDetail1, Long liveCountry2Fid,
			Long liveProvince2Fid, Long liveCity2Fid, String liveDetail2,
			Long workFid, Long industryNowFid, Long industryThinkFid,
			String telephoneFirst, String telephoneSecond, String handsetFirst,
			String handsetSecond, String mailFirst, String mailSecond,
			String messageFirst, String messageOther, String fax,
			String homepage, String selfResume, String selfFond,
			String selfSpeciality, String selfDiscover, String selfHonour,
			String selfBase, String selfMemo, String isOpenBase,
			String isOpenCity, String isOpenSchool, String photoUrl,
			String isPhotoShow, String isPartJoin, String partDuty,
			Long confidenceFid, String gradeFid, Long closeFid, String typeFid,
			Long updateUser, Date updateTime, String studyYear,
			String studyMajor, String studyClass, Long openFid, String userPwd,
			String userCard, String idStar, String mailSchool,
			String studyAcademy, String studyDepartment, String userLogin,
			String currentFid, String handsetThree, String isSend,
			String isAdd, String sendNote, String remark1, String remark2,
			String remark3, String remark4, String liveYear,
			String studyDegree, String studyYear1, String liveYear1,
			String studyAcademy1, String studyDepartment1, String studyMajor1,
			String studyClass1, String studyDegree1, String knowername,
			Long alumniLevel, String alumniOrgan, String alumniBlog) {
		this.sid = sid;
		this.rid = rid;
	...
	public String getIsOpenCity() {
		return this.isOpenCity;
	}

	public void setIsOpenCity(String isOpenCity) {
		this.isOpenCity = isOpenCity;
	}

	public String getIsOpenSchool() {
		return this.isOpenSchool;
	}
