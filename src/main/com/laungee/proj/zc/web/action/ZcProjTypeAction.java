...
public class ZcProjTypeAction extends BaseAction {
	// 处理请求
	...
	public String doAdd() throws Exception {
		...
		// 属性信息
		TbZcprojType tb=new TbZcprojType();
		tb.setTypeCode(code);
		...
		// 排序号
		String numHql="select max(a.numOrder) from TbZcprojType a where a.parentId="+parentId;
	...
	public String doEdit() throws Exception {
		...
		String memo=request.getParameter("memo");
		// 属性信息
		TbZcprojType tb=(TbZcprojType)getCommonBo().get(TbZcprojType.class, new Long(typeId));
